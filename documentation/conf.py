...
# -*- coding: utf-8 -*-
#
# MonteCoffee documentation build configuration file, created by
...
htmlhelp_basename = 'MonteCoffeedoc'
...
man_pages = [
    (master_doc, 'montecoffee', 'MonteCoffee Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MonteCoffee', 'MonteCoffee Documentation',
     author, 'MonteCoffee', 'One line description of project.',
     'Miscellaneous'),
]
...
sys.path.append('../NeighborKMC/tutorials/B2_ads/')
