...
def EadsCO(CN,strain):
  return 1.36 + 0.25 * (7.5 - CN) - 0.085 * strain

def EadsO(CN,strain):
  return 0.97 + 0.22 * (7.5 - CN) - 0.105 * strain
...
def get_Ea(ECO, EO):
    ...
    """
    dEO = EO - EadsO(7.5,0.0)  # Oxygen energy relative to uncovered Pt(111)
    dECO = ECO - EadsCO(7.5,0.0)  # CO energy relative to uncovered Pt(111)
...
def get_repulsion(cov_self, cov_NN, GCN):
    ...
    stype_factor = 0.5 if GCN < 4.0 else 1.0
    repulsion = 0.
